...
public function getStudents(){
    ...
    STUDENTS.STUDENT_PROMOTION, 
    COUNTRY.COUNTRY_NAME, 
    CITY.CITY_PC, 
    CITY.CITY_NAME, 
    ADDRESS.ADDRESS_STREET, 
    ADDRESS.ADDRESS_NB_APPARTEMENT, 
    USERS.USERS_IMG
    FROM USERS 
    JOIN ADDRESS ON USERS.ID_ADDRESS = ADDRESS.ID_ADDRESS 
    JOIN CITY ON ADDRESS.ID_CITY = CITY.ID_CITY 
    JOIN COUNTRY ON CITY.ID_COUNTRY = COUNTRY.ID_COUNTRY 
    JOIN STUDENTS ON USERS.ID_STUDENTS = STUDENTS.ID_STUDENTS
    WHERE USERS.ID_ADMIN IS NULL AND USERS.ID_PILOT IS NULL;");
...
public function getCompany(){
    ...
    COMPANY.COMPANY_IMG
    FROM COMPANY 
    JOIN ADDRESS ON COMPANY.ID_ADDRESS = ADDRESS.ID_ADDRESS 
    JOIN CITY ON ADDRESS.ID_CITY = CITY.ID_CITY 
    JOIN COUNTRY ON CITY.ID_COUNTRY = COUNTRY.ID_COUNTRY;");
...
public function getPilot(){
    ...
    JOIN CITY ON ADDRESS.ID_CITY = CITY.ID_CITY 
    JOIN COUNTRY ON CITY.ID_COUNTRY = COUNTRY.ID_COUNTRY 
    JOIN PILOT ON USERS.ID_PILOT = PILOT.ID_PILOT
    WHERE USERS.ID_ADMIN IS NULL AND USERS.ID_STUDENTS IS NULL;");
...
public function getOffer(){
    ...
    INTERNSHIP.INTERNSHIP_SHEDULE, 
    INTERNSHIP.INTERNSHIP_REMUNERATION, 
    INTERNSHIP.INTERNSHIP_SKILLS, 
    INTERNSHIP.INTERNSHIP_PLACE_NB, 
    COMPANY.COMPANY_NAME
    FROM INTERNSHIP 
