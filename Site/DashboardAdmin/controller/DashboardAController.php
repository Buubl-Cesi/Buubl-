...
class DashboardAController {
    ...
    public function createStudents($navbar,$name_student, $fname_student, $mail_student, $login_student, $password_student, $promotion_student, $country_student, $pc_student, $city_student, $street_student, $numap_student, $pfp_student){
    ...
    public function updateStudents($navbar,$name_student, $fname_student, $mail_student, $login_student, $password_student, $promotion_student, $country_student, $pc_student, $city_student, $street_student, $numap_student, $pfp_student){
    ...
    public function deleteStudents($navbar,$login_student){
    ...
    public function createCompany($navbar,$name_company, $activity_company, $desc_company, $country_company, $pc_company, $city_company, $street_company, $numap_company, $pfp_company){
    ...
    public function updateCompany($navbar,$name_company, $activity_company, $desc_company, $country_company, $pc_company, $city_company, $street_company, $numap_company, $pfp_company){
    ...
    public function deleteCompany($navbar,$name_company){
    ...
    public function createPilot($navbar,$name_pilot, $fname_pilot, $mail_pilot, $login_pilot, $password_pilot, $promotion_pilot, $country_pilot, $pc_pilot, $city_pilot, $street_pilot, $numap_pilot, $activity_pilot){
    ...
    public function updatePilot($navbar,$name_pilot, $fname_pilot, $mail_pilot, $login_pilot, $password_pilot, $promotion_pilot, $country_pilot, $pc_pilot, $city_pilot, $street_pilot, $numap_pilot, $activity_pilot){
    ...
    public function deletePilot($navbar,$login_pilot){
        // A implémenter
    ...
    public function createOffer($navbar,$name_offer, $desc_offer, $duration_offer, $start_offer, $end_offer, $hour_offer, $pricing_offer, $skills_offer, $nb_offer, $company_name){
    ...
    public function updateOffer($navbar,$name_offer, $desc_offer, $duration_offer, $start_offer, $end_offer, $hour_offer, $pricing_offer, $skills_offer, $nb_offer, $company_name){
        //  ajouter la méthode 
    ...
    public function deleteOffer($navbar,$name_offer){
        // A implémenter
...
// ETUDIANT ----------------------------------------------------------------------------------------------------------        
        if ($action == 'createStudent') {
            ...
            $dashboardAController->createStudents($navbar,$name_student, $fname_student, $mail_student, $login_student, $password_student, $promotion_student, $country_student, $pc_student, $city_student, $street_student, $numap_student, $pfp_student);
        }
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->updateStudents($navbar,$name_student, $fname_student, $mail_student, $login_student, $password_student, $promotion_student, $country_student, $pc_student, $city_student, $street_student, $numap_student, $pfp_student);
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->deleteStudents($navbar,$login_student);
        }
...
// ENTREPRISE ----------------------------------------------------------------------------------------------------------
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->createCompany($navbar,$name_company, $activity_company, $desc_company, $country_company, $pc_company, $city_company, $street_company, $numap_company, $pfp_company);
        }
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->updateCompany($navbar,$name_company, $activity_company, $desc_company, $country_company, $pc_company, $city_company, $street_company, $numap_company, $pfp_company);
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->deleteCompany($navbar,$name_company);
...
// PILOTE ----------------------------------------------------------------------------------------------------------        
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->createPilot($navbar,$name_pilot, $fname_pilot, $mail_pilot, $login_pilot, $password_pilot, $promotion_pilot, $country_pilot, $pc_pilot, $city_pilot, $street_pilot, $numap_pilot, $activity_pilot);
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->updatePilot($navbar,$name_pilot, $fname_pilot, $mail_pilot, $login_pilot, $password_pilot, $promotion_pilot, $country_pilot, $pc_pilot, $city_pilot, $street_pilot, $numap_pilot, $activity_pilot);
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->deletePilot($navbar,$login_pilot);
...
// OFFRE ----------------------------------------------------------------------------------------------------------
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->createOffer($navbar,$name_offer, $desc_offer, $duration_offer, $start_offer, $end_offer, $hour_offer, $pricing_offer, $skills_offer, $nb_offer, $company_name);
        }
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->updateOffer($navbar,$name_offer, $desc_offer, $duration_offer, $start_offer, $end_offer, $hour_offer, $pricing_offer, $skills_offer, $nb_offer, $company_name);
            ...
            $pdo = Connexion();
            $dashboardAController = new DashboardAController($pdo);
            $dashboardAController->deleteOffer($navbar,$name_offer);
        }
    }
    ...
    $pdo = Connexion();
        $dashboardAController = new DashboardAController($pdo);
        $dashboardAController->display($navbar);
    }
